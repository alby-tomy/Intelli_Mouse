    ...
    if len(lmList) != 0:
        ...
        if finger[1] == 1 and finger[2] == 0:
            ...
            autopy.mouse.move(wScr - cX,
                              cY)
            #pyautogui.dragTo(wScr - cX, cY, button='left')
            pX, pY = cX, cY

        if finger[1] == 1 and finger[0] == 1:
            autopy.mouse.click()

        if finger[1] == 1 and finger[2] == 1 and finger[0] == 0 and finger[3] == 0:
             pyautogui.click(button='right')

        if finger[1] == 1 and finger[2] == 1 and finger[0] == 0 and finger[3] == 1:
           pyautogui.scroll(60)

        if finger[1] == 1 and finger[2] == 0 and finger[0] == 0 and finger[3] == 0 and finger[4] == 1:
           pyautogui.scroll(-60)
